export const Plants = [
	{
		...
		outdoorSeed: [
			...
			{
				directions:
					'Prepare beds by digging 6 - 10 inches in well drained soil',
				image: null,
			},
			{
				directions:
	...
	},
	{
		...
		requirements: [
			...
			'Well-drained Soil',
			'Sandy loamy Soil',
			'Soil Acidity between 6.5 - 7.0 pH',
		],
		depth: 2,
		spacing: 18,
		height: 24,
		...
		days_to_harvest_short: 670,
		days_to_harvest_long: 670,
		sun: 'Full',
		water: null,
		pH: [6.5, 7],
		...
		non_companions: ['garlic', 'leeks', 'onion', 'potato'],
		avoid: [],
		indoorSeed: [],
		outdoorSeed: [],
		starter: [
			{
				directions: 'Locate a permanent planting space',
				image: null,
			},
			{
				directions:
					'Prepare the bed by digging trenches 4 feet apart and 12 inches wide and 6 to 12 inches deep',
				image: null,
			},
			{
				directions: 'Mix in a 2 to 4 inch layer of compost',
				image: null,
			},
			{
				directions: 'Soak the crowns briefly in lukewarm water',
				image: null,
			},
			{
				directions:
			...
			{
				directions:
					'Cover the crowns with a mix of one part compost to three parts topsoil, burying the crowns 2 inches deep',
				image: null,
			},
			{
				directions: 'Water the bed thoroughly',
				image: null,
			},
			{
				directions:
					'After about a month, once shoots have appeared, carefully add more soil to the trench.',
				image: null,
			},
		],
		zone: {
	...
	},
	{
		...
		days_to_harvest_short: 45,
		days_to_harvest_long: 65,
		sun: '',
		water: null,
		pH: [],
		nutrient: [],
		...
		outdoorSeed: [
			...
			{
				directions: 'Prepare the bed by loosening soil to 8 inches',
				image: null,
			},
			{
				directions: 'Place 1 inch apart in a row',
				image: null,
			},
			{
				directions: 'Cover seeds with 1/2 to 3/4 inches of soil',
				image: null,
			},
			{
				directions: 'Water the bed thoroughly',
	...
	},
	{
		...
		soil_temp_high: 85,
		days_to_germinate: null,
		days_to_harvest_short: 90,
		days_to_harvest_long: 90,
		sun: 'Full',
		water: null,
		pH: [],
		nutrient: [],
